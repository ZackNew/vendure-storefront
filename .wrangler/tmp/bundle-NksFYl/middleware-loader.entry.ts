...
import worker from '/root/vendure/storefront-qwik-starter/.wrangler/tmp/bundle-NksFYl/middleware-insertion-facade.js';
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from '/root/vendure/storefront-qwik-starter/node_modules/.pnpm/wrangler@3.28.1/node_modules/wrangler/templates/middleware/common.ts';

// We need to preserve all of the exports from the worker
export * from '/root/vendure/storefront-qwik-starter/.wrangler/tmp/bundle-NksFYl/middleware-insertion-facade.js';
